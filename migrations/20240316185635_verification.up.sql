...
create table verifications (
    ...
    expired BOOLEAN NOT NULL DEFAULT 0, -- Просрочен или нет
    sended BOOLEAN NOT NULL DEFAULT 0,  -- Отправлен или нет

    model_id INTEGER,                   -- ID сущности к которой привязан
    model_type VARCHAR(50),             -- Название таблицы для корректного поиска

    options JSON NOT NULL DEFAULT "{}",   -- Дополнительный настройки
